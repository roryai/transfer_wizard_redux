...
def test_copies_multiple_files():
    ...
    FileFactory(source_filepath_1, target_root_directory).create_pre_copy_file()
    FileFactory(source_filepath_2, target_root_directory).create_pre_copy_file()
    FileFactory(source_filepath_3, target_root_directory).create_pre_copy_file()

...
def test_generates_path_including_year_and_quarter():
    ...
    generated_path = generator.generate_target_filepath(source_filepath, target_root_directory)
...
def test_adds_suffix_to_filename_if_there_is_a_name_clash_with_existing_file():
    ...
    path = generator.generate_target_filepath(source_filepath, target_root_directory)
